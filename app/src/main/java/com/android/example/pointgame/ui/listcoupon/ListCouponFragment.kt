...
import com.android.example.pointgame.databinding.FragmentListCouponBinding

class ListCouponFragment : Fragment() {
    private var _binding: FragmentListCouponBinding? = null
